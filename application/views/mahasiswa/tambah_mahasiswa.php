...
echo form_open('mahasiswa_tambah', $attributes);
?>
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group has-feedback">
                                    <label>NIM</label>
                                    <input type="text" class="form-control input-sm" name="nim" autocomplete="off" autofocus autocapitalize="true" required="true">
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                </div>
                                <div class="form-group has-feedback">
                                    <label>Nama Mahasiswa</label>
                                    <input type="text" class="form-control input-sm" name="nama_mhs" autocomplete="off" autofocus autocapitalize="true" required="true">
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                </div>
                                <div class="form-group has-feedback">
                                    <label>Jurusan</label>
                                    ...
                                    endforeach;
                                    unset($r);
                                    echo form_dropdown('kode_jurusan', $options, '', 'class="form-control input-sm" tabindex="2" required  autocomplete="off"');
                                    ?>
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                </div>
                                <div class="form-group has-feedback">
