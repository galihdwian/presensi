<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>List Tambahan Lampiran Kegiatan</h2>
                <div class="nav navbar-right panel_toolbox">
                    <div class="dropdown">
                        <a href="<?= site_url('admin/kegiatan/tambah_kegiatan_lampiran/' . $id); ?>" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
            ...
            <div class="x_content">
                <table id="mytable" class="table table-bordered table-centeredhead">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($list_kegiatan_tambahan as $r) :
...
<script type="text/javascript">
    function Delete(id) {
        window.location.href = "<?php echo site_url('admin/kegiatan/delete_kegiatan_lampiran'); ?>/" + id + '/' + <?= $id ?>;
    }

    function Edit(id) {
        window.location.href = "<?php echo site_url('admin/kegiatan/edit_kegiatan_lampiran'); ?>/" + id + '/' + <?= $id ?>;
    }
