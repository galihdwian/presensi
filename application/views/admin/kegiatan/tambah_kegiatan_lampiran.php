...
echo form_open_multipart('admin/kegiatan/tambah_kegiatan_lampiran/' . $id, $attributes);
?>
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Data Tambah Lampiran Kegiatan</h2>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group has-feedback">
                                    <label>Upload Foto Tambahan</label></br>
                        ...
                        <div class="pull-right">
                            <a href="<?= site_url('admin/kegiatan/tambahan/' . $id); ?>" class="btn btn-warning" id="btnBatal">Batal</a>
