        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="nav navbar-right panel_toolbox">
                    <div class="dropdown">
                        <a href="<?= site_url('admin/sk_komkordik/tambah_sk_komkordik'); ?>" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
...
<script type="text/javascript">
    function Delete(id) {
        window.location.href = "<?php echo site_url('admin/sk_komkordik/delete_sk_komkordik'); ?>/" + id;
    }
</script>