...
echo form_open_multipart('adminppid/donasi/master-satuan/tambah', $attributes);
?>
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Tambah Master Satuan Donasi</h2>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control input-sm" name="nama_satuan" value="<?= set_value('nama_satuan'); ?>" autocomplete="off" autofocus autocapitalize="true" required="true">
