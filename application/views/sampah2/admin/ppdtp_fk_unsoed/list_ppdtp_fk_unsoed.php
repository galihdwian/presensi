<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>List PPDTP FK Unsoed</h2>
                <div class="nav navbar-right panel_toolbox">
                    <div class="dropdown">
                        <a href="<?= site_url('admin/ppdtp_fk_unsoed/tambah_ppdtp_fk_unsoed'); ?>" class="btn btn-primary">
                            Tambah
                        </a>
                    </div>
                </div>
...
<script type="text/javascript">
    function Delete(id) {
        window.location.href = "<?php echo site_url('admin/ppdtp_fk_unsoed/delete_ppdtp_fk_unsoed'); ?>/" + id;
    }
</script>