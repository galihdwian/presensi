<section id="services">
    <div class="container">
        <div style="margin-top: 150px; padding-bottom:120px;"></div>
                ...
                <div class="well">
                    ...
                    <div class="form-group">
                        <div class="pull-right">
                            <button type="submit" name="submit" class="btn btn-danger btn-outline"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</button>
                        </div>
                    </div>
        ...
        <div style="margin-top: 100px; padding-top: 180px;"></div>
    </div>
</section>